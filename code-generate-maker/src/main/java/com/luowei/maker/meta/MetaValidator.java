...
import com.luowei.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    private static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "luowei");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.luowei");
